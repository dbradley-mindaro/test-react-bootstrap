      ...
      <Row>
        <Container fluid bg="light">
          <Image
            ...
            fluid={true}
            rounded
            src="https://files.wallpaperpass.com/2020/02/simpsons_wallpaper_65-1332x850-1-768x490.jpg"
          />
        </Container>
      </Row>
      <Row>
        ...
        <p>
          ...
          officia, numquam aliquam cupiditate dicta cum? Suscipit voluptates hic
          tempore soluta at?
        </p>
        <p>
          ...
          pariatur voluptates sapiente quo reprehenderit, beatae exercitationem?
        </p>
      </Row>
    </Container>
  );
